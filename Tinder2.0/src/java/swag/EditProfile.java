 ...
 private final char QUOTE = '"';
    ...
    {  
        ...
        if(success)
            try {
                Statement stmt = conn.createStatement();
                sql = "Update account SET full_name = '" + name + "', age = " + age + ", sex = '" + sex + "' WHERE account_id = " + id;
                message = "Account details updated!";
                
                session.setAttribute("account", new Profile(name, Integer.parseInt(age), sex, id));
      ...
      pw.println("<!DOCTYPE HTML PUBLIC " + QUOTE +
        ...
        "<HTML>\n" + "<HEAD>\n" +
        "<TITLE>Tinder 2.0 - Profile Edited</TITLE>\n" + "</HEAD>\n" + "<BODY>\n" +
